...
[1단계: Container Terminal 서비스 신청](#1단계-container-terminal-서비스-신청)

[2단계: Container Terminal 접속](#2단계-container-terminal-접속)

[3단계: OpenShift 로그인 및 CLI 사용](#3단계-openshift-로그인-및-cli-사용)
...
> :bell:**안내**:원하는 비밀번호가 없는 경우 K-ECP 운영팀에서 임의로 설정합니다.(ID는 사번입니다.)
